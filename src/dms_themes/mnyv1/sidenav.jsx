  ...
  let sizes = {
    ...
    full: {
      fixed: '',
      wrapper: "",
      sideItem: "group flex pl-3 py-2 text-[14px] font-[Oswald] font-medium  text-slate-700 ml-2  border-white",
      sideItemActive: "group flex pl-3 py-2 text-[14px] font-[Oswald] font-medium text-slate-700 ml-2   border-white",
  ...
  let sidenav =  {
    ...
    menuIconSide: `${sizes[size].icon} `,
    menuIconSideActive: `${sizes[size].iconActive}`,
