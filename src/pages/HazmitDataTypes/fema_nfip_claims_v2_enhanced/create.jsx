...
const CallServer = async ({rtPfx, baseUrl, source, newVersion, navigate, viewNFIP, viewDDS, viewCounty, viewJurisdiction, viewBlockGroup, user}) => {
...
const Create = ({ source, newVersion, baseUrl, context }) => {
    ...
    const { user, falcor, datasources } = React.useContext(context || DamaContext)
    ...
    React.useEffect(() => {
        async function fetchData() {
            ...
            await getSrcViews({rtPfx, falcor, pgEnv, setVersions: setVersionsBlockGroup, type: 'tl_blockgroup'});
