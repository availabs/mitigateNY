...
function Create({
    ...
    const bildSources = useGetSources({
        falcorCache,
        pgEnv,
        categories: ["Enhanced Footprints"],
        columns: ["ogc_fid"]
    });
    console.log("bildSources", bildSources);

    useFetchSourceViews({ falcor, falcorCache, pgEnv, source_id: createState.bildSourceId });

    const bildViews = useGetViews({ falcorCache, pgEnv, source_id: createState.bildSourceId });
    ...
    return (
        <div className="group mb-40">
            ...
            <SourceAndViewSelectors
                ...
                sources={bildSources}
                sourceKey="bildSourceId"
                sourceValue={createState.bildSourceId}

                views={bildViews}
                viewKey="bildViewId"
                viewValue={createState.bildViewId}
