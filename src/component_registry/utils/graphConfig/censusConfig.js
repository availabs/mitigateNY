export default {
    ...
    B16001: {
        ...
        variables : [
            ...
            {name:'Greek Speak English very well',value:'B16001_030E'},
    ...
    B23008: {
        ...
        variables : [
            {name: 'Total',value:'B23008_001E'}, // 0
            {name: 'Under 6 years',value:'B23008_002E'},
            {name: 'Living with two parents',value:'B23008_003E'}, //2
            ...
            {name: 'Living with father',value:'B23008_022E'}, // 21
            {name: 'In labor force',value:'B23008_023E'},
            {name: 'Not in labor force',value:'B23008_024E'},
            {name: 'Living with mother',value:'B23008_025E'}, // 24
    ...
    B25118:{
        ...
        variables: [
            ...
            {name:'$5k-$9,999',value:'B25118_004E'},
            {name:'$10k-$14,999',value:'B25118_005E'},
            {name:'$15k-$19,999',value:'B25118_006E'},
            {name:'$20k-$24,999',value:'B25118_007E'},
            {name:'$25k-$34,999',value:'B25118_008E'},
            {name:'$35k-$49,999',value:'B25118_009E'},
            {name:'$50k-$74,999',value:'B25118_010E'},
            {name:'$75k-$99,999',value:'B25118_011E'},
            {name:'$100k-$149,999',value:'B25118_012E'},
            {name:'$150k or more',value:'B25118_013E'},
            {name:'Renter Occupied',value:'B25118_014E'},
            {name:'Less than $5,000',value:'B25118_015E'},
            {name:'$5k-$9,999',value:'B25118_016E'},
            {name:'$10k-$14,999',value:'B25118_017E'},
            {name:'$15k-$19,999',value:'B25118_018E'},
            {name:'$20k-$24,999',value:'B25118_019E'},
            {name:'$25k-$34,999',value:'B25118_020E'},
            {name:'$35k-$49,999',value:'B25118_021E'},
            {name:'$50k-$74,999',value:'B25118_022E'},
            {name:'$75k-$99,999',value:'B25118_023E'},
            {name:'$100k-$149,999',value:'B25118_024E'},
            {name:'$150k or more',value:'B25118_025E'}
        ]
    },
    B25087:{
        ...
        variables:[
            ...
            {name:'$300-$399',value:'B25087_005E'},
            {name:'$400-$499',value:'B25087_006E'},
            {name:'$500-$599',value:'B25087_007E'},
            {name:'$600-$699',value:'B25087_008E'},
            ...
            {name:'$2,500-$2,999',value:'B25087_016E'},
            {name:'$3,000-$3,499',value:'B25087_017E'},
            {name:'$3,500-$3,999',value:'B25087_018E'},
            ...
            {name:'$100-$149',value:'B25087_022E'},
            {name:'$150-$199',value:'B25087_023E'},
            {name:'$200-$249',value:'B25087_024E'},
            {name:'$250-$299',value:'B25087_025E'},
            {name:'$300-$349',value:'B25087_026E'},
            {name:'$350-$399',value:'B25087_027E'},
            {name:'$400-$499',value:'B25087_028E'},
            {name:'$500-$599',value:'B25087_029E'},
            {name:'$600-$699',value:'B25087_030E'},
            {name:'$700-$799',value:'B25087_031E'},
            {name:'$800-$899',value:'B25087_032E'},
            {name:'$900-$999',value:'B25087_033E'},
            {name:'$1000-$1099',value:'B25087_034E'},
            {name:'$1100-$1199',value:'B25087_035E'},
            {name:'$1200-$1299',value:'B25087_036E'},
            {name:'$1300-$1399',value:'B25087_037E'},
            {name:'$1400-$1499',value:'B25087_038E'},
    ...
    B14003:{
        ...
        variables:[
            ...
            // {name:'Enrolled in public school',value:'B14003_003E'},
            {name:'ages 3 and 4, enrolled in school',value:'B14003_004E'},
            {name:'ages 5 to 9, enrolled in school',value:'B14003_005E'},
            {name:'ages 10 to 14, enrolled in school',value:'B14003_006E'},
            {name:'ages 15 to 17, enrolled in school',value:'B14003_007E'},
            {name:'ages 18 and 19, enrolled in school',value:'B14003_008E'},
            {name:'ages 20 to 24, enrolled in school',value:'B14003_009E'},
            {name:'ages 25 to 34, enrolled in school',value:'B14003_010E'},
            {name:'ages 35 and over, enrolled in school',value:'B14003_011E'},
            // {name:'ages Enrolled in private school',value:'B14003_012E'},
            {name:'ages 3 and 4, enrolled in private school',value:'B14003_013E'},
            {name:'ages 5 to 9, enrolled in private school',value:'B14003_014E'},
            {name:'ages 10 to 14, enrolled in private school',value:'B14003_015E'},
            {name:'ages 15 to 17, enrolled in private school',value:'B14003_016E'},
            {name:'ages 18 and 19, enrolled in private school',value:'B14003_017E'},
            {name:'ages 20 to 24, enrolled in private school',value:'B14003_018E'},
            {name:'ages 25 to 34, enrolled in private school',value:'B14003_019E'},
            {name:'ages 35 and over, enrolled in private school',value:'B14003_020E'},
            // {name:'Not enrolled in school',value:'B14003_021E'},
            {name:'ages 3 and 4, not enrolled in school',value:'B14003_022E'},
            {name:'ages 5 to 9, not enrolled in school',value:'B14003_023E'},
            {name:'ages 10 to 14, not enrolled in school',value:'B14003_024E'},
            {name:'ages 15 to 17, not enrolled in school',value:'B14003_025E'},
            {name:'ages 18 and 19, not enrolled in school',value:'B14003_026E'},
            {name:'ages 20 to 24, not enrolled in school',value:'B14003_027E'},
            {name:'ages 25 to 34, not enrolled in school',value:'B14003_028E'},
            {name:'ages 35 and over, not enrolled in school',value:'B14003_029E'},
            // {name:'Female',value:'B14003_030E'},
            // {name:'Enrolled in public school',value:'B14003_031E'},
...
B01001: { // Added a new one for graphs
    ...
    B01002: {
        ...
        variables:[
            ...
            {name:'S',value:'B23025_002E'},
            {name:'T',value:'B23025_003E'},
            {name:'U',value:'B23025_004E'},
            {name:'V',value:'B23025_005E'},
            {name:'W',value:'B23025_006E'},
            {name:'X',value:'B23025_007E'}
        ]
    }
    ,
    C02003:{
    ...
    B22005A:{
        name: 'Receipt of Food Stamps/SNAP by Race (White)',
        variables:[
            'B22005A_001E',
            'B22005A_002E',
            'B22005A_003E'
    ...
    B22005B:{
        name: 'Receipt of Food Stamps/SNAP by Race (Black or African American Alone)',
        variables:[
            'B22005B_001E',
            'B22005B_002E',
            'B22005B_003E'
    ...
    B22005C:{
        name: 'Receipt of Food Stamps/SNAP by Race (American Indian and Alaska Native)',
        variables:[
            'B22005C_001E',
            'B22005C_002E',
            'B22005C_003E'
    ...
    B22005D:{
        name:'Receipt of Food Stamps/SNAP by Race (Asian)',
        variables:[
            'B22005D_001E',
            'B22005D_002E',
            'B22005D_003E'
    ...
    B22005E:{
        name: 'Receipt of Food Stamps/SNAP by Race (Native Hawaiian and Other Pacific Islander)',
        variables:[
            'B22005E_001E',
            'B22005E_002E',
            'B22005E_003E'
    ...
    B22005F:{
        name: 'Receipt of Food Stamps/SNAP by Race (Some Other Race Alone)',
        variables:[
            'B22005F_001E',
            'B22005F_002E',
            'B22005F_003E'
    ...
    B22005G:{
        name: 'Receipt of Food Stamps/SNAP by Race (Two or More Races)',
        variables:[
            'B22005G_001E',
            'B22005G_002E',
            'B22005G_003E'
    ...
    B22005H:{
        name: 'Receipt of Food Stamps/SNAP by Race (White Alone, Not Hispanic or Latino)',
        variables:[
            'B22005H_001E',
            'B22005H_002E',
            'B22005H_003E'
    ...
    B22005I:{
        name: 'Receipt of Food Stamps/SNAP by Race (Hispanic or Latino)',
        variables:[
            'B22005I_001E',
            'B22005I_002E',
            'B22005I_003E'
    ...
    B05001:{
        name: 'Immigrant/Refugee indicators',
        variables:[
            'B05001_001E',
            'B05001_002E',
            'B05001_003E',
    ...
    B25125:{
        name: 'Tenure by Age of Structure',
        variables:[
            'B25125_001E',
            'B25125_002E',
            'B25125_003E',
    ...
    B25075:{
        name: 'Housing Units Value by Bucket',
        variables:[
            //These have 27 variables mentioned in the excel but 25 on the acs census list
        ]
    },
     ------------------------For the variable B16001 ---------------------------------------
